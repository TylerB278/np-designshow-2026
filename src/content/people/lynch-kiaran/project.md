...
images:
  - src: "project_2.jpg"
    alt: "A preview of READING Issue #2, emphasizing the project’s editorial and documentary components. On the left, the magazine cover is shown in full view, with the same character featured front and center. Below the title, the issue highlights a conversation with Printed Matter, Inc., situating the project within real-world publishing networks. On the right, two spreads of the magazine issue are featured: the top features an example of the photography featured in the magazine. The bottom image shows another interior spread, pairing a short written foreword with another illustration of the character speaking into a microphone, suggesting interviews and storytelling."
    size: 2
  - src: "project_3.jpg"
    alt: "In this image, READING Issue #1 is in focus, placing the magazine cover against a backdrop composed of blurred film stills from the accompanying documentary. The background reveals glimpses of bookstore interiors, shelves, and interviewees to be featured in each conversation. The magazine acts as a curated version, or a “best-of” of each interview, distilling ideas and points made into a structured editorial form, while the film stills suggest a more immediate, observational approach to the same subject matter. The contrast between the foreground and background highlights this relationship: one medium frames and interprets, the other records and immerses."
    size: 2
---
