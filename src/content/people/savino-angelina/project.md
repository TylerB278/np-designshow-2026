...
thumbnail:
  src: "project_1.png"
  alt: "The title ‘Faces of the Divine’ in bold pink serif lettering appears over a torn-paper style white background, framed by classical columns and a soft pink collage backdrop."
images:
  - src: "project_2.png"
    alt: "A card box titled ‘Faces of the Divine’ in pink serif type sits upright with 2 cards leaning against it. The cards feature a collage of a classical statue, flowers, and abstract textures on a pink background."
    size: 2
  - src: "project_3.png"
    alt: "A card box titled ‘Faces of the Divine’ in pink serif type sits centered on a pink surface, surrounded by colorful collage-style cards featuring classical sculptures, animals, flowers, and natural elements."
    size: 2
---
