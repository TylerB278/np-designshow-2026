...
thumbnail:
  src: "project_1.png"
  alt: 'A wide, wave-like digital collage of diverse overlapping orange-themed design artifacts and graphic elements, forming a curated collection on a clean white background. Includes a title card below that reads "for the love of orange," the designers name "hart frable" and below that an orange rectangle with the year "2026."'
images:
  - src: "project_2.png"
