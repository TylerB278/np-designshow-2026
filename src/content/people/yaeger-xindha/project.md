...
portfolio: https://xindhayaeger.myportfolio.com/work
bio: |
...
images:
  - src: "project_2.png"
    alt: "Alphabet repeating in bold type with Vietnamese diacritics, white text on red background"
    size: 2
  - src: "project_3.png"
    alt: "book laying flat with letter A design on left and finished bold letter A on right"
    size: 1
  - src: "project_4.png"
    alt: '"Mekong: A Typeface Inspired by Vietnamese Signage" red text on white background in bold font'
    size: 1
  - src: "project_5.png"
    alt: "Collage of hand drawn bold letters on graph paper"
    size: 2
---
